LadiPageScriptV2.prototype.parseFormCheckoutProduct = function(e) {
		...
		if (1 === o.length) {
			...
			(X = n.parseFormCheckoutProduct(c)).quantity = 1;
			var d = c.querySelector(".ladi-form-checkout-payment-quantity input");
			isEmptyLadiPage(d) || (X.quantity = parseInt(d.value) || X.quantity), r.push(X)
		...
		var s = isObjectLadiPage(n.runtime.payment_setting) ? n.runtime.payment_setting : {},
			...
			O = !0,
			S = 0,
			T = isObjectLadiPage(n.runtime.tmp.form_data_value_all) ? n.runtime.tmp.form_data_value_all : {},
			x = function(e, t) {
				var a = Object.assign(n.copy(T), n.copy(p));
			...
			N = function(a) {
				...
				var c = 0,
					...
					u = "";
				i == n.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(o) || n.showMessage(o, m)), i == n.const.FORM_THANKYOU_TYPE.popup && (d && n.setDataReplaceElement(!1, !1, m, o), window.ladi(o).show(!1, {
					formThankyouPopupXInline: r
				})), i != n.const.FORM_THANKYOU_TYPE.url && i != n.const.FORM_THANKYOU_TYPE.url_default || isEmptyLadiPage(a) || (o = window.ladi(a).encode_thankyou_url(), u = x(o, d), c += 1e3, n.runTimeout(function() {
					window.ladi(u).open_url()
				}, c)), t.resetFormValue(e.querySelector(".ladi-form"))
			},
			C = function(e, t) {
				"Success" == e && N(t.thanks_url), "Canceled" == e && n.showMessage(n.const.LANG.FORM_CHECKOUT_ORDER_CANCEL)
			};
		...
		var R = function(e, t) {
				...
				if (o && r ? o.style.display = "none" : o && (o.style.display = ""), isEmptyLadiPage(document.getElementById(a))) {
					...
					a.style.display = "block", i.style.display = "none", o.style.display = "block",
						function e() {
							...
							a.textContent = `${String(s).padStart(2,"0")} phút ${String(u).padStart(2,"0")} giây`, d > 0 ? S = n.runTimeout(e, 1e3) : (i.style.textAlign = "center", i.style.display = "block", i.style.color = "#E01A1A", i.style.maxWidth = "632px", o.style.display = "block", t.style.display = "none", r.style.display = "none", w = !0)
						}()
				}(5), A = !0);
			...
			q = "true" === e.getAttribute("is_auto_funnel"),
			D = "";
		s.thankyou_type == n.const.FORM_THANKYOU_TYPE.url && (D = x(s.thankyou_value, q)), isEmptyLadiPage(n.runtime.tmp.form_checkout_order_id) && (n.runtime.tmp.form_checkout_order_id = n.randomString(10)), n.showLoadingBlur();
		var F = localStorage.getItem("previousSubmission");
		...
		try {
			var B = {
				...
				G = I.variants.length !== Y.length;
			if (!G)
				for (var H = 0; H < Y.length; H++) !I.variants[H] || I.variants[H].product_id === Y[H].product_id && I.variants[H].product_variant_id === Y[H].product_variant_id && I.variants[H].quantity === Y[H].quantity || (G = !0);
			var J = function(e) {
				var t = {
					type: null,
					bank_code: null
			...
			B.type = J.type, B.bank_code = J.bank_code;
			var K = I.customer_name !== _ || I.customer_email !== g || I.customer_phone !== f,
				$ = I.data_payment.code !== B.code || I.data_payment.type !== B.type || I.data_payment.bank_code !== B.bank_code;
			G && (K = !0);
			var V = K;
			!K && $ && (V = !1);
			var W = e.id;
			let t = n.runtime.tmp[W + "_data_discount_coupon_selected"] || null,
				i = n.runtime.tmp[W + "_data_discount_shipping_selected"] || null,
				o = n.runtime.tmp[W + "_data_method_shipping_selected"] || null;
			var z = "";
			...
			try {
				z = document.getElementById(W).getAttribute("data-fb-event-id")
			} catch (e) {}
			var X = JSON.stringify({
					order_note: h,
					accept_policy: y,
					tracking_script: (M = [], j = "ladi_run_tracking_" + n.randomString(10), U = `window.${j} = function (data) {\n                    try {\n                        new Function(data.str)();\n                        console.log(data.str);\n                    } catch (e) {\n                        setTimeout(function () {\n                            window.${j}(data);\n                        }, 100);\n                    }\n                };`, M.push(U), isArrayLadiPage(n.runtime.tmp.form_checkout_tracking_script) && n.runtime.tmp.form_checkout_tracking_script.forEach(function(e) {
						M.push(`window.${j}(${JSON.stringify({str:e})});`)
					}), 1 == M.length && (M = []), M.join("")),
					...
					path_type: "product",
					cart_token: !V && window.ladi("CART_TOKEN_FORM_CHECKOUT").get_cookie(),
					checkout_token: !V && window.ladi("CHECKOUT_TOKEN_FORM_CHECKOUT").get_cookie(),
			...
			Z.addEventListener("readystatechange", function() {
				4 === this.readyState && (! function(e) {
					try {
						...
						if (isObjectLadiPage(t.data.bank_info) && !t.data.bank_info.qr_url && !isEmptyLadiPage(t.data.bank_info.base_64_qrCode)) return void R(t.data, !0);
			...
			}), Z.open("POST", n.const.API_LADISALE_CHECKOUT_PAYMENT), Z.setRequestHeader("Content-Type", "application/json"), Z.send(X), I = {
				customer_name: _,
				customer_email: g,
				customer_phone: f,
				variants: Y,
				data_payment: B
			}, localStorage.setItem("previousSubmission", JSON.stringify(I))
		} catch (e) {
			n.hideLoadingBlur()
		}
		...
		var s = function() {
			...
			p = function() {
				...
				const c = a.id;
				var d = null;
				document.querySelectorAll(`#${c} .ladi-form-checkout-product-check.multiple.checked`).forEach(e => {
					const n = e.closest(".ladi-form-checkout-box");
					n && (d = t.parseFormCheckoutProduct(n))
				}), l.contentWindow.isFirstClickMethodPayment = i, l.contentWindow.payment_continue = u, l.contentWindow.payment_cancel = s, l.contentWindow.payment_setting = e, l.contentWindow.current_select = o, l.contentWindow.ladi_uid = t.runtime.store_ladiuid, l.contentWindow.end_point_api = t.const.API_LADISALE_LIST_GATEWAY, l.contentWindow.objDataProduct = d, l.contentDocument.open(), l.contentDocument.write(r), l.contentDocument.close()
			};
		...
		try {
			...
			return this.showMessage(this.const.LANG.FORM_VALIDATE_CHECKOUT_PRODUCT), !1
		}
		try {
			var t = JSON.parse(e.getAttribute("data-payment"));
			if (0 == Object.keys(t).length) throw new TypeError("no payment")
		} catch (t) {
			if (e.querySelectorAll('[data-form-checkout-item="payment"] div[data-payment-code]').length > 1) return this.showMessage(this.const.LANG.FORM_VALIDATE_CHECKOUT_PAYMENT);
			...
			var n = e.querySelector('[data-form-checkout-item="payment"] .ladi-form-checkout-payment-content');
			return n && n.click(), !1
		}
		return !0
		...
		var e = this,
			...
			m = function(n, a, i) {
				try {
					...
					let l = u ? u.textContent : "";
					var o = "",
						r = "";
					const p = document.getElementById(n);
					if (p) {
						const e = p.querySelector('input[name="email"]'),
							t = p.querySelector('input[name="phone"]');
					...
					e.sendRequest("POST", e.const.API_LADISALE_VALIDATE_COUPON_CODE, JSON.stringify(m), !0, d, function(t, a, i) {
						if (i.readyState == XMLHttpRequest.DONE) try {
							var o = JSON.parse(t);
							if (200 == a) {
								if (200 == o.code) {
									...
									if (t && (a = t.querySelector(".checkout-block-discount-coupon"), i = t.querySelector("#value-coupon-code"), r = t.querySelector("#shipping-coupon"), c = t.querySelector("#value-coupon-shipping-code")), isObjectLadiPage(o.data)) {
										if (a && a.setAttribute("data-coupon-code", o.data.discount_code), a && isObjectLadiPage(o.data.discount_shipping) && a.setAttribute("data-coupon-shipping-code", o.data.discount_shipping.code), i) {
											...
											t.textContent = "✖", t.style.marginLeft = "8px", t.style.border = "none", t.style.background = "transparent", t.style.cursor = "pointer", t.style.color = "red", t.style.fontSize = "14px", t.addEventListener("click", function() {
												i.textContent = l, i.removeAttribute("style"), a && a.removeAttribute("data-coupon-code"), e.runtime.tmp[n + "_data_discount_coupon_selected"] = null, g(n)
											}), i.appendChild(t)
										}
			...
			g = function(t) {
				...
				try {
					...
					let p = _(t) || [];
					if ("none" != window.getComputedStyle(e).display && p.length > 0) {
						p.forEach(e => {
							o += e.price * e.quantity
						}), n && n.discount_price ? (d = o - n.discount_price, c = n.discount_price) : d = o, i && i.length > 0 && (d -= r = n && 0 == n.allow_promotion ? 0 : i.reduce((e, t) => t.discount ? 1 == t.discount.type ? t.price <= t.discount.value ? e : e + t.price * (t.discount.value / 100) * t.quantity : t.price <= t.discount.value ? e : e + t.discount.value * t.quantity : e, 0));
						const m = document.querySelector("#" + t + ' [data-form-checkout-item="fee_shipping"]');
						...
						a && (u = a.fee, d -= a.fee), d < 0 && (d = 0), l(e.id, o, r, c, d, s, u)
					}
				} catch (e) {
					console.log("err.........", e)
				}
